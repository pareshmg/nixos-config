...
;;(setq org-todai-file  (if (string-match-p (regexp-quote "todai") (system-name)) (concat org-directory "todai.org")))
(setq org-todai-file  (concat org-directory "todai.org"))
...
;;(setq org-phd-file (concat org-directory "PhD.org"))
                                        ...
                                        ;(setq org-todai-jira-file "~/.org-jira/MM.org")
...
(setq org-capture-templates
      (append
       `(
                                        ; Generic next action
         ("n" "Next Action" entry (file+headline ,org-gtd-file "Next Actions")
          "* TODO %?\n %i")
                                        ; Grocery action
       ...
       (if org-todai-file
           '(
             ("t" "TODAI Templates")
             ("tt" "TODAI Me" entry (file+olp org-todai-file "Todo" "Paresh")
              "* TODO %?\n  %i")
             ))
       (if org-orya-file
           '(
