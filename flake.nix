...

{
  ...
  outputs =
    ...
    , u
    , ...
    } @ inputs: # Function that tells my flake which to use and what do what to do with the dependencies.
    ...
    # Use above variables in ...
    {
      ...
      darwinConfigurations = {
        ...
        cmtmac = self.darwinConfigurations.pmpcmt;
      };
      ...
      homeConfigurations = {
        ...
        ubuntu =
          ...
          home-manager.lib.homeManagerConfiguration {
            inherit pkgs;
            extraSpecialArgs = { inherit inputs system pkgs agenix secrets home-manager profile u location cmtcfg; };
            modules = [
        ...
        ${secrets.profile.per.user} =
          ...
          home-manager.lib.homeManagerConfiguration {
            inherit pkgs;
            extraSpecialArgs = { inherit inputs system pkgs agenix secrets home-manager profile u location; };
            modules = [
              agenix.homeManagerModules.default
              ./linux/minimal-home.nix
              ./linux/home.nix
